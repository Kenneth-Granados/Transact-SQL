...
--substring(cadena,inicio,longitud): devuelve una parte de la cadena especificada como primer argumento, empezando desde la posición especificada 
...
--- str(numero,longitud,cantidaddecimales): convierte números a caracteres; el primer parámetro indica el valor numérico a convertir, 
--el segundo la longitud del resultado (debe ser mayor o igual a la parte entera del número más el signo si lo tuviese) y el tercero, 
--la cantidad de decimales. El segundo y tercer argumento son opcionales y deben ser positivos. String significa cadena en inglés.Ejemplo: se 
--convierte el valor numérico "123.456" a cadena, especificando 7 de longitud y 3 decimales: 
...
--se convierte el valor numérico "123.456" a cadena: 
select str(123.456); 
select str(123.456,3); -- Si el segundo parámetro es menor a la parte entera del número, devuelve asteriscos (*). Ejemplo: 
...
--reemplazando la cantidad de caracteres indicada por el tercer argumento en la cadena que es primer parámetro. Stuff significa rellenar en inglés.Ejemplo: 
...
--Los argumentos numéricos deben ser positivos y menor o igual a la longitud de la primera cadena, caso contrario, retorna "null". Si el tercer argumento es 
--mayor que la primera cadena, se elimina hasta el primer carácter. 
...
--Si el tercer argumento no se coloca, la búsqueda se inicia desde 0. Si no la encuentra, retorna 0. Ejemplos: 
